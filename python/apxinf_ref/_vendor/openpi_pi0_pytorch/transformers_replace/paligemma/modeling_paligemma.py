...
class PaliGemmaModel(PaliGemmaPreTrainedModel):
    ...
    def __init__(self, config: PaliGemmaConfig):
        ...
        # Use the package-local replacements directly.  A stock Transformers
        # AutoModel registry does not know about these replacement config
        # classes, even though their module names match the stock classes.
